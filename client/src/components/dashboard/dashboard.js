    ...
    return (
        <div className="flex flex-col w-full h-full">
            ...
            <div className='flex basis-11/12 flex-row'>
                <div className='flex flex-col basis-1/5 border-r-2 border-teal-50 bg-teal-50 py-5 px-3'>
                    <button
                        className='flex flex-row w-full gap-2 items-center hover:bg-teal-100 pl-6 py-3 rounded-2xl'
